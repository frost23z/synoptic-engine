...
class SettingsPermissionRegistry : PermissionRegistry {
    override fun permissions(): List<PermissionDefinition> =
        listOf(
            ...
            def(SettingsPermissions.ATTRIBUTES_EDIT, "Create and edit attributes"),
            ...
            def(SettingsPermissions.AUTOMATIONS_EDIT, "Create and edit automations"),
            ...
            def(SettingsPermissions.MARKETING_EDIT, "Create and edit campaigns"),
