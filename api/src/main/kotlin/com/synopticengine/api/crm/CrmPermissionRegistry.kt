...
class CrmPermissionRegistry : PermissionRegistry {
    override fun permissions(): List<PermissionDefinition> =
        listOf(
            ...
            def(CrmPermissions.CONTACTS_PERSONS, "Manage contact persons"),
            def(CrmPermissions.CONTACTS_PERSONS_VIEW, "View contact persons"),
            def(CrmPermissions.CONTACTS_PERSONS_CREATE, "Create contact persons"),
            def(CrmPermissions.CONTACTS_PERSONS_EDIT, "Edit contact persons"),
            def(CrmPermissions.CONTACTS_PERSONS_DELETE, "Delete contact persons"),
            def(CrmPermissions.CONTACTS_ORGANIZATIONS, "Manage contact organizations"),
            def(CrmPermissions.CONTACTS_ORGANIZATIONS_VIEW, "View contact organizations"),
            def(CrmPermissions.CONTACTS_ORGANIZATIONS_CREATE, "Create contact organizations"),
            def(CrmPermissions.CONTACTS_ORGANIZATIONS_EDIT, "Edit contact organizations"),
            def(CrmPermissions.CONTACTS_ORGANIZATIONS_DELETE, "Delete contact organizations"),
